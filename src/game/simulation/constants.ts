...
export const SHIP_SAFE_SUBMERGE_DEPTH_ABSOLUTE_MAX = 0.24;
export const SHIP_SAFE_SUBMERGE_DEPTH_DRAFT_RATIO = 0.24;
export const SHIP_SAFE_SUBMERGE_PROBE_PEAK_BLEND = 0.25;
export const SHIP_SAFE_DESCENT_VELOCITY_CAP = -0.22;
export const SHIP_SAFE_SUBMERGE_SOFT_BAND = 0.035;
export const SHIP_SAFE_SUBMERGE_HARD_BAND = 0.12;
export const SHIP_SAFE_SOFT_RECOVERY_GAIN = 7.0;
...
export const MOVEMENT_DRAG = 0.89;
export const MOVEMENT_MAX_TURN_RATE = 2.2;
export const MOVEMENT_TURN_ACCEL = 6;
export const MOVEMENT_TURN_LOW_SPEED_MULT = 0.07;
export const MOVEMENT_TURN_MID_SPEED_START = 0.45;
export const MOVEMENT_TURN_MID_SPEED_END = 0.65;
export const MOVEMENT_TURN_HIGH_SPEED_MULT = 0.55;
export const MOVEMENT_TURN_IDLE_SPEED_THRESHOLD = 0.1;
export const MOVEMENT_TURN_IDLE_INPUT_MULT = 0.22;
export const MOVEMENT_TURN_IDLE_ANGULAR_CAP = 0.12;
export const MOVEMENT_LATERAL_DAMPING = 0.3;
...
export const MOVEMENT_THROTTLE_RESPONSE = 7;
